...
const ProductDetail = () => {
    ...
    const { user } = useUser(); // Sử dụng hook useUser để lấy thông tin user
                ...
                <div className={styles.right}>
                    ...
                    <div className={styles.priceWrapper}>
                        {product.discountPrice < product.price && (
                            <p className={styles.originalPrice}>{Number(product.price).toLocaleString()}₫</p>
                        )}
                        <p className={styles.discountPrice}>{Number(product.discountPrice).toLocaleString()}₫</p>
                    </div>
